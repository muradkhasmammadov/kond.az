/*  ---------------------------------------------------
    ...
    Version: 1.0
    Created:---------------------------------------------------------  */
// var arr = "Hər növ kondisioner  kombi və paltaryuyan maşinlarin təmiri üçün bizə müraciət edə bilərsiniz!!! KondisionerUstasi";
// var i = 0;
// var k = 0;
// $(document).ready(function(){
//     setInterval(function(){
//     if(arr[i]!=' '){
//     $('.nav-logo h2').append(arr[i]);
//         i++;    
//     }
//     else{
//         $('.nav-logo h2').html($('.nav-logo h2').html().slice(0,-1));
//         if($('.nav-logo h2').html().length==0){
//             i++;
//         }
//     }
//     },200)
